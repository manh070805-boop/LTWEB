...
namespace TrungTamLapTrinh.Web.Areas.Admin.Controllers
{
    ...
    public class DashboardController : Controller
    {
        ...
        public DashboardController(TrungTamLapTrinhContext context)
        {
            _context = context;
        }
        public IActionResult Index()
        {
            ...
            var receivedPayments = payments
                .Where(p => p.Status.StatusCode.Equals("SUCCESS", StringComparison.OrdinalIgnoreCase)
