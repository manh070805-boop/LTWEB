...
('Teacher', N'Giảng viên'),
('Student', N'Học viên');

INSERT INTO CourseLevel (LevelCode, LevelName)
VALUES
('BEGINNER', N'Cơ bản'),
...
INSERT INTO ClassStatus (StatusCode, StatusName)
VALUES
('OPEN', N'Mở đăng ký'),
('ONGOING', N'Đang học'),
('CLOSED', N'Đã đóng'),
...
INSERT INTO EnrollmentStatus (StatusCode, StatusName)
VALUES
('PENDING', N'Chờ duyệt'),
('APPROVED', N'Đã duyệt'),
('ACTIVE', N'Đang học'),
...
INSERT INTO PaymentMethod (MethodCode, MethodName)
VALUES
('CASH', N'Tiền mặt'),
('BANK', N'Chuyển khoản'),
('VNPAY', N'VNPay'),
...
INSERT INTO PaymentStatus (StatusCode, StatusName)
VALUES
